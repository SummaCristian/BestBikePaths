    ...
    \subsection{Purpose}
        ...
        \subsubsection{Goals}
            \begin{enumerate}[label=G\arabic*:, itemsep=0.5em]
              ...
              \item \textbf{Provide meaningful trip insights:} The system shall analyse recorded trips and present users with relevant statistics, such as distance, duration, and performance metrics.
    ...
    \subsection{External Interface Requirements}
        \subsubsection{Users Interfaces}
            ...
            \begin{figure}[H]
                ...
                \vspace{1em} % small vertical spacing between rows
                ...
                \caption{Mockup screens of the BBP mobile app UI layout}
                \label{fig:mockups}
            \end{figure}
